...
QUALITY_FLOOR = 0.30      # calibrated: 143 faces vs 400 pots, rejects 99.8% of pots
STRIDE = 1                # every frame; the 0.30 floor keeps only ~36%

detector = face.get_face_detector()

print(f"harvesting EVERY frame, quality floor {QUALITY_FLOOR} ...")
pools = {}
...
with open("/home/grazzy/media/sweep_clean.json", "w") as fh:
